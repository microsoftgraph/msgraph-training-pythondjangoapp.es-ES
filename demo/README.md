...
- [Python](https://www.python.org/) (con [PIP](https://pypi.org/project/pip/)) instalado en el equipo de desarrollo. Si no tiene Python, visite el vínculo anterior para las opciones de descarga. (**Nota:** este tutorial se ha escrito con Python versión 3.8.2 y Django versión 3.0.4. Los pasos de esta guía pueden funcionar con otras versiones, pero no se han probado.
